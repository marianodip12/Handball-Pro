...
export const PlansPage = () => {
  ...
  const handleSelectPlan = (plan: Plan) => {
    ...
    if (plan === 'free') return;
    // Por ahora, solo mostramos un alert. Después conectamos con Stripe/MercadoPago.
    alert(`¡Pronto vas a poder activar el plan ${plan.toUpperCase()}!\n\nEstamos trabajando en la integración con MercadoPago y tarjetas de crédito.\n\nMientras tanto, podés escribirnos por WhatsApp para ser de los primeros.`);
  };
